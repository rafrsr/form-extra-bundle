...
use Rafrsr\FormExtraBundle\Autocomplete\AutocompleteContext;
...
abstract class AutocompleteBaseExtension extends AbstractTypeExtension implements ContainerAwareInterface
{
    ...
    public function finishView(FormView $view, FormInterface $form, array $options)
    {
        if ($options['autocomplete']) {
            ...
            $contextId = $this->container->get('rafrsr_form.autocomplete.context_manager')->addContext($context);
            ...
            if (!$options['autocomplete_url']) {
                ...
                $options['autocomplete_url'] = $url;
            }

            $view->vars['autocomplete_options'] = $options;
        }
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(
            [
                ...
                'autocomplete_route' => 'rafrsr_form_extra_autocomplete',
